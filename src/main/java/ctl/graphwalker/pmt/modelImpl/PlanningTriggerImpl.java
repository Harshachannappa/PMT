...
public class PlanningTriggerImpl extends ExecutionContext implements PlanningTrigger {
	...
	public void v_CorrectData() {
		...
		Assert.assertTrue("Text not found!", Helper.getWaiter().until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='msgBox']"))).getText().contains("Saved Successfully"));
